...
async fn test_limit_inodes() {
    ...
    thread '<unnamed>' (1) panicked at guests/python/src/lib.rs:329:13:
    cannot prepare root filesystem for Python: DataFusionError { context: [], kind: DataFusionErrorKind::Execution("I/O error (os error 29)") }
