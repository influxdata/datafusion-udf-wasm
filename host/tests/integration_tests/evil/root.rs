...
async fn test_invalid_entry() {
    ...
    scalar_udfs
    caused by
    This feature is not implemented: serialize error: IO error: numeric field was not a number:  when getting cksum for foo
    ");
}
...
async fn test_many_files() {
    ...
    scalar_udfs
    caused by
    This feature is not implemented: serialize error: IO error: I/O error (os error 29)
    ");
}
...
async fn test_not_tar() {
    ...
    scalar_udfs
    caused by
    This feature is not implemented: serialize error: IO error: failed to read entire block
    ");
}
...
async fn test_sparse() {
    ...
    scalar_udfs
    caused by
    This feature is not implemented: serialize error: IO error: Unsupported TAR content: GNUSparse @ huge
    ");
}
...
async fn test_unsupported_entry() {
    ...
    scalar_udfs
    caused by
    This feature is not implemented: serialize error: IO error: Unsupported TAR content: Symlink @ foo
    ");
}
